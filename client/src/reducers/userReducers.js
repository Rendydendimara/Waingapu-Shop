...
// handle userSiginReducer 
function userSiginReducer(state={}, action) {
	switch(action.type) {
		case USER_SIGNIN_REQUEST:
			return { loading: true }
		case USER_SIGNIN_SUCCESS:
		    // tambahkan data user yang berhasil login
...
// handle userRegisterReducer 
function userRegisterReducer(state={}, action) {
	switch(action.type) {
		case USER_REGISTER_REQUEST:
			return { loading: true }
		case USER_REGISTER_SUCCESS:
			// tambahkan data user yang berhasil register
			return { loading: false, userInfo: action.payload };
...
// handle userUpdateReducer 
function userUpdateReducer(state = {}, action) {
  switch (action.type) {
    case USER_UPDATE_REQUEST:
      return { loading: true };
    case USER_UPDATE_SUCCESS:
      // update data user infor
      return { loading: false, userInfo: action.payload, success: 'Profile updated successfully' };
